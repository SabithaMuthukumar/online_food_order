            ...
            if (empty($errors)) {
                if ($payment_method === 'cash') {
                    ...
                    if ($deliveryStmt->execute()) {
                        ...
                        $transStmt = $conn->prepare("INSERT INTO Trans (Trans_id, Ord_id, Pay_Mode, Pay_Status, Amount) 
            ...
            <div class="confirmation">
                ...
                <div class="delivery-info">
                    ...
                    <?php if ($delivery_person_name !== 'Not assigned yet'): ?>
                        <p>Your order will be delivered by <strong><?php echo htmlspecialchars($delivery_person_name); ?></strong></p>
