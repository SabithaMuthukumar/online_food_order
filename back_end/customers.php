...
$result = $conn->query("SELECT Cust_id, Name, Phno, Address, Email, Gender, password, Registered_date FROM customer_det ORDER BY Cust_id DESC");
?>
...
.styled-table td:nth-child(8) {
    ...
    white-space: nowrap; /* Keeps the date in one line */
}
</style>
