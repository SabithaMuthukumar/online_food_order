    ...
    <form action="edit_delivery_person.php?id=<?php echo $id; ?>" method="post" onsubmit="return validateForm()">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="status" name="status" required>
                <option value="Active" <?php echo ((isset($_POST['status']) && $_POST['status'] == 'Active') || $delivery_person['Status'] == 'Active') ? 'selected' : ''; ?>>Active</option>
                <option value="Inactive" <?php echo ((isset($_POST['status']) && $_POST['status'] == 'Inactive') || $delivery_person['Status'] == 'Inactive') ? 'selected' : ''; ?>>Inactive</option>
